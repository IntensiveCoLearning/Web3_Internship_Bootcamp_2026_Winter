...
没赶上听 Box 讲 DevRel 的事...那就只能明天看回放了
...
今天听了 Web3 行业的求职和简历会议，对投递简历和 ABetterWeb3 这个平台有更多了解了
...
这份内容主要来自 "Web3BuidlerTech" 的《以太坊中文周会（2026/01/26 期）》。内容涵盖了**以太坊生态的最新简报**、**对 Vitalik 近期言论的深度解读**，以及**对 2026 年加密市场（BTC、ETH、SOL 及山寨币）的宏观展望**。

以下是对会议核心内容的详细总结：

### 1\. 每周简报与市场动态

-   **RWA 与链上美股热潮**：当前市场对代币化美股和美债的热情高于纯加密资产。Chainlink 宣布提供链上数据流，支持代币化美股 ETF 场景。基础设施项目 State 完成了 8250 万美元融资，旨在构建面向 SEC 注册股票的全链发行设施。
    
-   **SocialFi 的困境**：SocialFi 赛道面临挑战。Lens Protocol 被 Mask 接手；Farcaster 虽融资 1.5 亿美元，但以低于融资估值的价格被收购，创始人退出，引发社区对其资金使用效率和未来信心的质疑。
    
-   **安全与监管**：Saga EVM 遭遇攻击损失约 700 万美元。Nifty Gateway 宣布将于 2 月关闭。Space 预测市场因 ICO 超募退款问题引发社区不满。监管方面，美国 SEC 和 CFTC 将举办联合活动聚焦加密协调。
    
-   **宏观与支付**：美元霸权受到威胁，各国央行购金，同时也在通过稳定币巩固美元地位。Bybit 因日本监管收紧将逐步结束对日服务。
    

### 2\. 深度解读：Vitalik 的转变与以太坊治理

-   **Vitalik 的风格转变**：自 2026 年 1 月 1 日起，Vitalik Buterin 在 X（推特）上密集发布长文，语气坚定，强调以太坊必须在大规模扩容（百万 TPS）的基础上保持去中心化。
    
-   **技术愿景**：他提出“The Way”测试（即在无人维护下网络仍能运行），强调抗量子计算、简化质押方案、状态过期（防止状态爆炸）以及降低协议复杂度。他批评以太坊代码日益臃肿，认为只有少数博士能看懂是不可持续的。
    
-   **社区分歧与挑战**：
    
    -   **治理影响力**：评论指出，以太坊这艘“大船”已难以掉头。Vitalik 的“极简主义/去中心化”愿景与当前由 DeFi 和金融机构主导的“利益最大化”现状存在冲突。他的言论被视为对现状的纠偏，但实际推动改革面临巨大的结构性阻力。
        
    -   **核心人员变动**：前以太坊基金会研究员 Justin Drake 离职加入 TLE，理由是认为以太坊不应过度为 DeFi 优化，而应关注个人主权，这也反映了内部战略方向的分歧。
        

### 3\. 2026 年主流资产展望 (BTC, ETH, SOL)

会议引用了 G 先生（Gwart?）的宏观分析，对三大资产进行了预测：

-   **比特币 (BTC) - 缺乏催化剂**：
    
    -   2025 年回顾：ETF 成功，但机构采用参差不齐。
        
    -   2026 年展望：**前景偏向负面**。缺乏正面催化剂（该进场的政府/机构已进场），且面临 MicroStrategy 可能转为抛压、四年周期进入熊市阶段、以及量子计算风险等负面因素。BTC 已变成一种宏观 Beta 资产。
        
-   **以太坊 (ETH) - 定位最佳**：
    
    -   2025 年回顾：稳定币和 DeFi 领域确立了绝对主导地位（占稳定币总市值的 60%）。
        
    -   2026 年展望：**优于 BTC**。拥有独特的“三位一体”叙事（数字黄金+数字石油+数字美元结算层）。虽然面临资产定义模糊（货币 vs 实用代币）和 L2 割裂的风险，但在机构采用和监管合规方面具有护城河。
        
-   **Solana (SOL) - 身份危机**：
    
    -   2025 年回顾：从“高性能链”退化为“Meme 赌场”，用户流失率极高（98%）。
        
    -   2026 年展望：**面临严峻挑战**。Hyperliquid 的出现抢走了“高性能+去中心化”的叙事，使其处于尴尬的中间地带。面临监管诉讼风险，且开发者正在流失（如旗舰项目 GP 离开）。
        

### 4\. 山寨币市场与未来机会

-   **山寨币的崩塌与“柠檬市场”**：2025 年被称为“山寨币最艰难的一年”。原因归结于 2021-2022 年 VC 泡沫导致的“低流通、高 FDV”代币发行模式，导致市场充斥着只有抛压没有需求的项目。这种模式摧毁了融资渠道，甚至引发了“柠檬市场”效应（劣币驱逐良币）。
    
-   **未来 12 个月预期**：市场仍需消化最后一波代币解锁的冲击，这可能是痛苦的“出清”阶段。
    
-   **2026 年潜在爆发赛道**：
    
    1.  **稳定币与支付**：特别是 B2B 跨境支付和 Neo-Banks（新银行）业务，这是加密与传统金融融合的关键。
        
    2.  **DeFi**：作为稳定币的收益来源，随着稳定币规模扩大，DeFi TVL 也会增长。
        
    3.  **预测市场**：结合世界杯和美国中期选举，可能迎来流量爆发。
        
    4.  **AI 与加密融合**：赋予 AI “经济公民”身份（拥有钱包和支付能力），这是一个巨大的新增长点。
        
    5.  **代币机制重构**：任何能解决“低流通/高 FDV”困境的新发行模式都将受到追捧。
        

### 总结

整体而言，周会内容传达出一种\*\*“去伪存真”\*\*的趋势。2026 年被视为加密行业与传统金融加速融合的一年。市场不再盲目追逐基础设施叙事，而是转向关注实际产生的经济活动（如稳定币支付、DeFi 收益）。对于以太坊，尽管面临内部路线之争，但其作为“数字经济结算层”的地位依然稳固；而对于过度依赖 Meme 或缺乏实际护城河的项目，前景则较为黯淡。
