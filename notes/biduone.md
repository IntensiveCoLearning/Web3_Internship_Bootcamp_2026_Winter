...
中年小伙，探索人生新旅程。萌新入社写过两年Java工作需要转了Web前端、后来数年又搞过App跨平台开发RN、Flutter，基于headlessCMS开发过单节点业务后台和写过工具脚本，算一个Node.js全栈吧，一直混迹toB的IM工具软件行业。    从2010年在校初识BTC->区块链技术破圈大🔥->NFT风靡，从远观逐渐靠近了解到Web3的路线。对链上的未来世界产生了浓厚的好奇感，对公开的不可篡改的真实世界充满希望⛓️，期待自己加入这场改变世界技术浪潮并贡献自己的力量。     个人喜欢🦶徒步亲近大自然，🚙自驾游历山川河流🏔️、探访不同地域🏞️人民生活风情风貌，尤其喜欢大西北。
...
2.  **Web3.career**
    ...
    -   **简介：** Web3.career 是一个专注于 Web3 领域的全球性招聘平台，汇集了大量来自区块链、加密货币、DeFi、NFT、元宇宙等领域的职位。**DeJob**
        
    
    -   **简介：** DeJob 是一个专注于 Web3 和远程招聘的平台，旨在帮助 Web3 项目方和求职者进行匹配
        
3.  **SmartDeer**
    
    -   **简介：** SmartDeer 是一个新兴的 Web3 人才招聘平台，专注于连接优质的 Web3 项目和专业人才。
        

4\. 其他

-   **Discord / Telegram 社区：** 许多 Web3 项目会在自己的官方社区中发布招聘信息，尤其是一些早期项目或需要社区参与的职位。
...
在经历了多次\*\*“割韭菜”之后，市场上的资金变得越来越谨慎\*\*，大量的流动**性被锁定在稳定币或**者主流资产中，无法形成有效的外溢。

宏观上的去杠杆化，具象化到围观场景，就是割韭菜。市场存量信心都受挫，多次市场波动导致投资者风险偏好降低。

资金避险情绪浓厚：流动性向稳定币和主流资产聚集。

## 未来的机会

-   放水：量化宽松
    
    当全球央行再次开启量化宽松，市场流动性将重新变得充裕。
...
研究每个赛道历史上的好项目，了解它们的成功经验和失败教训。

-   研究模型
    

深入研究代币经济模型，理解其内在价值和长期可持续性。

-   保持敏锐
    

持续关注行业动态与新兴技术，保持开放和学习的心态。
