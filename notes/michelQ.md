...
这两天主要学习了 Solidity 语言和合约编写。学习了 Hardhat3。已经练习编写过一些合约样例，并部署到了本地开发链中。今天学习了 Call, DelegateCall, MultiCall，合约升级、Gas 费优化等相关知识。
...
![image.png](https://raw.githubusercontent.com/IntensiveCoLearning/Web3_Internship_Bootcamp_2026_Winter/main/assets/michelQ/images/2026-01-14-1768398731320-image.png)

2、什么是 Delegate Call?

delegate call 是特殊的 message call，在调用过程中，上下文中的 msg.sender 和 msg.value 不变。Delegate Call 可以在运行时动态加载Code，为实现库合约提供了可能性。

![image.png](https://raw.githubusercontent.com/IntensiveCoLearning/Web3_Internship_Bootcamp_2026_Winter/main/assets/michelQ/images/2026-01-14-1768398709542-image.png)
