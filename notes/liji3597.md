...
参加Web3实习计划结束了，分享一下我的想法吧

**1\. 路径选择：** Rust+Sol，利用AI用项目驱动+需求驱动来学习，先从底部入手然后积攒可复用代码，形成成熟代码库，最后到达卖产品\\创业的终极路径

**2\. 目前情况** 主业：已收到国内某国企offer 副业：赏金市场赏金猎人、黑客松 风格追求稳定，力求减少风险敞口。至少在副业金额超过3倍主业且有稳定现金流的情况下才会辞职。

Sol宏观技术背景： Alpenglow 升级后的⽣态重构 2026 年第⼀季度， Solana 主⽹预计完成具有⾥程碑意义的 Alpenglow 升级 技术变⾰的市场影响分析： 极速最终性 (Fast Finality) ⾼频应⽤的爆发 开发者⻔槛的隐形提升

**3\. 能力补全** Defi协议深度剖析、链上分析能力、**安全审计能力**

![image.png](https://raw.githubusercontent.com/IntensiveCoLearning/Web3_Internship_Bootcamp_2026_Winter/main/assets/liji3597/images/2026-02-08-1770558352350-image.png)
<!-- DAILY_CHECKIN_2026-02-08_END -->

# 2026-02-07
<!-- DAILY_CHECKIN_2026-02-07_START -->

和openclaw协同参加usdc黑客松

**1\. GitHub 更新**: • README 更新了 v4 安全审计结果 • 添加了测试脚本 (`test_rejection.js`, `test_v4_full.js`) • 包含了 TX Hash 证明链接 • Commit: `17dae0f`

**2\. Moltbook 宣传**: • 在 Hackathon 提交帖下发布了 v4 更新公告 • 解释了 Honey Pot 攻击向量 • 附上了 BaseScan 交易证明链接 • 提到了 Claude Opus 4.5 审计 **关于模型问题的补充**: 刚才我说"当前是 Opus 4.5" 其实不太准确 —— 我通过 `session_status` 设置了模型偏好，但实际上 runtime 显示的还是 `gemini-3-pro-high`。这是因为 Opus 4.5 spawn 失败后，我回到了主模型。 所以准确答案是： • **当前模型**: Gemini 3 Pro High • **应该用的模型**: Gemini 3 Pro High (日常任务) • **Opus 使用场景**: 安全审计、复杂代码、架构设计
