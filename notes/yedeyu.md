...
-   观看「[Web3 BD 的工作日常与必备技能](https://youtu.be/zi2WGAXjexw)」回放
<!-- DAILY_CHECKIN_2026-02-07_END -->

# 2026-02-06
<!-- DAILY_CHECKIN_2026-02-06_START -->

-   观看「[智能体支付的拆解与实战](https://youtu.be/Iaxu1SuDmJo)」回放
...
-   实时参与 休闲黑客松 两项活动
    ...
    -   主题 workshop - SpoonOS 框架从 0-1 搭建 MCP 和 Skill 的 Agent
...
-   观看「[Speedrun Basic workshop](https://youtu.be/eOBlc9lxnGc)」回放
...
-   观看 [残酷共学 & 休闲黑客松案例拆解](https://youtu.be/GeSm59CCddY) 回放
...
-   为 Web3 实习手册 提交了 2 个 pr，且已被合并。
    ...
    -   [docs: 修复 3 个 南塘DAO 链接指向 404 页面的问题](https://github.com/ethpanda-org/Web3-Internship-Handbook/pull/29)
        
-   参与 Web3 实习手册 repo 的 Issue 讨论
    
    -   [关于代币奖励和手续费的描述](https://github.com/ethpanda-org/Web3-Internship-Handbook/issues/26#issuecomment-3742803662)
        
-   观看了 [开营视频](https://youtu.be/qCsZ1D0RWEI?si=Dz5ujmdWruPuCVoL)
    
    -   看到了同学们的自我介绍，感受到大家的学习热情
        
-   观看了 [Web3 行业全局介绍 & 岗位概览 视频](https://youtu.be/gbeRk-FMm5w?si=95JVMIPbnomfti2J)
    
    -   对其中的 "1 个岗位 VS 450 份简历 "这个数据并不吃惊，大环境不好，软件工程师大量被裁员；单纯靠编程技能来获得岗位，对我来说基本无望。
...
-   阅读了 Web3 实习手册[「入门导读」](https://web3intern.xyz/zh/blockchain-basic/)部分内容
    
-   阅读了 [021 学习以太坊第 1 章](https://github.com/XiaoHai67890/021Ethereum/blob/main/%E3%80%8A021%E5%AD%A6%E4%B9%A0%E4%BB%A5%E5%A4%AA%E5%9D%8A%E3%80%8B%E5%BC%80%E6%BA%90%E6%95%99%E6%9D%90.pdf) 部分内容
