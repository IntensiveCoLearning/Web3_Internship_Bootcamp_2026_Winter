...
1.  今天回顾了几个当时没时间听的分享会，对行业的了解又加深了
    
2.  整理了一下整个实习计划的学习内容，真的学习到了好多东西，从一个懵懵懂懂的小白，现在对基本的概念，热门的领域都有了自己的理解，真的很感谢实习计划给的这个机会
    
3.  本来还想试着卷一卷积分，发现完全卷不动了，好多任务错过了就是没有了，能完整学习下来也是无憾了
    
4.  到这里其实更多的是感慨吧，一个月的实习计划，让我真正感受到了时间的流动，每周都很充实，我的生活感觉有了新的锚点，参加实习计划前我其实挺迷茫的，完全不知道自己未来该做些什么。虽然现在依旧很迷茫，但感觉可能看到了一点不一样的可能吧，实习计划对我来说真的是一扇窗，让我走进了之前从未见过的风景中，让我知道世界上还有很多正在路上的理想主义者，这是笔记的最后一条了，不知道会不会有人看到，但还是感谢实习计划，感谢所有的同学老师，感谢遇见，祝我们都能成为更好的自己，江湖路远，期待与你们再见。
<!-- DAILY_CHECKIN_2026-02-08_END -->

# 2026-02-07
<!-- DAILY_CHECKIN_2026-02-07_START -->

1.  自此黑客松一次忘记打卡，感觉打卡得意识就变得淡薄了，仔细一看，差点要被淘汰了
    
2.  这两天都在开组会，有点力不从心了，投稿得文章意见也回来了，还得修改
    
3.  今天主要得任务是了解了一下近代编程语言的发展，前后端的框架之类，把常见的一些概念都摸清楚了
    
4.  此外，今天仔细学习了Rust的所有权概念，为了兼顾高效的内存管理和编程上的便利，所有权是一种用栈内存管理堆内存的方式，rust中变量天然不可变，可变需要mut，赋值时是把内存所有权转交，使用&可以只给使用权，变量脱离作用域{}自动释放，这算是rust最有特点的属性，挺有意思的，之后继续了解，保持学习
...
2.  趁着组会的空袭，完成了speedrunethurum，收获很多，寒假的时候继续做后面的内容
    
3.  有点迷茫了，搞不懂自己要做些什么，搞不懂未来到底在哪里，有时候只能靠忙碌来麻痹自己，期待未来有一天一切都能解决
...
1.  今天的主要任务还是依照任务学习，好好了解了一下UniswapV3，真的太巧妙了，笔记同步到了推上
    
2.  论文的审稿意见回来了，最近还有回复审稿意见，唉，好忙哇
    
3.  ERC标准还没怎么看，speedrunethurum也要做，明天又要开始开组会，有点焦头烂额了
...
1.  黑客松结束，今天休息了一天，再优化了一下黑客松的产品和readme
    
2.  马上要组会了，今天把论文初稿写完，明天开始投身实习计划的学习
    
3.  整个黑客松参加下来，最大的感受是感觉需要学一下前端的框架，学一下TS什么的，先把最近的任务完成一下，然后开始学TS，有时间再学一学RUST，学习的感觉真的好棒😀
...
3.  继续vibecoding，啊啊啊啊啊啊啊啊啊好难啊啊啊啊啊啊啊啊啊啊，AI呆呆的，我也傻傻的
...
2.  听了黑客松的开营仪式，激动激动，希望能学到东西
    
3.  学习了几个ERC标准，感觉有点迷惑，很多ERC的理念很简单，但涉及到细节技术很多还是有很多难点，但没有那种教程，感觉之后可以写一下
    
4.  和组员们讨论了一下选题和赛道，基本敲定了，明天开始加油
