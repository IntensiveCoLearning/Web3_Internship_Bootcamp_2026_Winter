...
1.参加「Web3 冬季实习计划结业典礼」  
**Web3 实习计划（冬季）**最后一天，时间过得好快。最后一天了，想写些什么，但是一时间又不知道从何说起。  
最初踌躇满志，每一项任务都认真完成，我以为自己会在实习计划完成后顺利实现自己的目标。不幸的是，女朋友在第二周发生了一些意外，我不得不从加拿大赶回来，整个节奏因此完全断掉，任务堆积起来根本没时间完成。第三周参加了黑客松，也没有取得自己理想的结果，黑客松结束后感觉自己整个就松懈掉了，最后一周已经完全没有了最初的斗志，尝试去追上进度，但是很难做到了。  
  
不想埋怨各种因素，但是自己还是没有尽到全力吧。尽管如此，我还是收获了很多，认识了朋友，参加了第一次黑客松，成为了LXDAO的一名member，也对web3的世界有了更进一步的认识。在此，还是要感谢ETHPanda和LXDAO组织的此次实习计划，你们真的太酷了，真心感谢你们大家的努力！虽然遗憾没有完全消化你们大家努力付出的内容，成为本次实习的佼佼者。但是对我来说，此次实习计划更像是一扇通往web3世界大门，大门打开，让我领略了其中的繁华与精彩。接下来，我也不会放弃，努力穿过这扇门，追上深处精彩世界的你们。
...
1.参与 LXDAO 周会 260207  
2.分享会 - Reactive Workshop & 大使计划
...
1.**学习10 个** [**ERC 标准**](https://ethpanda.notion.site/ERC-2debbd63be8781e49eb3eaf5e75fb1c1)  
**2.线上 Co-Learning**
...
1.根据教程，进行 Hardhat 跟练

2.根据教程，进行 Foundry 跟练

3.完成一个 Gas 优化案例

4.线上 Co-Learning  

明天完成 Reactive Contracts 构建跨链功能作业
...
1.线上 Co-Learning  
2.收听【学员 Mini 活动】手把手带你用 OpenCode 做出一个“死了么”网页  
3.查看「就业简历指导 & 面经分享」回放  
4.查看以太坊中文周会 260202 回放
...
今天主要参与了黑客松比赛，这是我第一次参加此类活动，整体体验十分激动也很新鲜。虽然在项目中个人直接产出的成果有限，但在高强度协作和实战环境中学习到了许多新知识，也结识了不少志同道合的朋友，对团队协作和快速开发有了更直观的认识。

赛后复盘主要有以下两点收获与反思：

1.  **AI 辅助开发能力有待提升**  
    在有限时间内完成黑客松项目，对开发效率提出了很高要求。本次在前期 AI 的部署上消耗了较多精力，且在实际调用 AI 进行代码开发时缺乏系统性和方法论，整体较为零散。后续需要重点学习和实践更成熟的 AI 开发流程，例如 _vibe coding_ 等高效的人机协作方式，以提升在时间受限场景下的开发能力。
    
2.  **演示前的完整测试非常关键**  
    在最终演示前，应严格围绕演示内容提前进行多轮测试，确保流程顺畅、效果稳定，避免临场出现可预见的问题。这不仅能提升展示质量，也有助于增强团队整体的专业度和自信心。
    

总体而言，本周是一次非常宝贵的实践与学习经历，不仅拓宽了技术视野，也让我更清楚地认识到自身在 AI 开发和项目呈现方面的提升方向。
...
报名黑客松，成功组队后参与讨论，并且进行vibe coding
...
1\. 查看「Vibe Coding + 黑客松经验分享」回放 √

2\. 查看「Speedrun Basic workshop（英）」回放 √

3\. 查看 休闲黑客松 Open Day √

黑客松小分队开展第一次会议，确定了黑客松赛道和项目大概雏形。明天对所选技术内容进行体验，确定工作量。
