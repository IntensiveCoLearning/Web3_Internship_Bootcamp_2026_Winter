...
2.  **比特币 (Bitcoin) —— “第一个应用”**：基于区块链诞生的**数字货币**。它的目标是做“去中心化的黄金”，解决货币转账不需要中介的问题。→**核心逻辑：去中心化的“账本”（公共账本）**
    ...
    1.  **核心逻辑**：
        ...
        -   **挖矿（PoW）**：通过消耗电力和算力来竞争记账权，确保账本的安全。
...
3.  **以太坊 (Ethereum) —— “操作系统”**：基于区块链诞生的**智能合约平台**。它不仅能转账，还能运行代码（App），被称为“全球计算机”。→**核心：去中心化的“计算机”（全球计算机），解决功能局限**
    ...
    1.  **定义**：以太坊是在比特币基础上进化的**智能合约平台**。
        ...
        -   **核心逻辑**：
            ...
            -   **智能合约（Smart Contract）**：如果说比特币是“计算器”，只能算加减法，那以太坊就是“电脑”。它可以运行逻辑，比如：“如果甲方完成了任务，钱就自动转给甲方”。
...
4.  **Web3 —— “互联网愿景”**：基于上述技术构建的**下一代互联网，**本质是**互联网范式的转移**。其核心逻辑是“**读 + 写 + 拥有**”，将数据和资产的所有权还给个人。其驱动力在于降低社会运行的**信任成本**。→**核心逻辑：去中心化的“所有权”**
...
![image.png](https://raw.githubusercontent.com/IntensiveCoLearning/Web3_Internship_Bootcamp_2026_Winter/main/assets/klhbd/images/2026-01-18-1768740932630-image.png)
