...
来源  
Web3intern 实习手册：[区块链基础概念](https://web3intern.xyz/zh/blockchain-basic/#_1-web2-%E5%BD%93%E5%89%8D%E4%BA%92%E8%81%94%E7%BD%91)
...
关键对比（金融结算视角）  
节点加入：公链任何人可加入；联盟链需联盟治理/授权；私链由管理者决定。  
数据可见性：公链公开；联盟链部分公开；私链内部可见。  
读写权限：公链开放读，写需按规则参与共识；联盟链对联盟成员开放读，写对授权节点开放；私链读写由单一机构配置与控制。  
适用场景：公链更适合面向公众的开放式金融与公开可验证结算；联盟链更适合多机构清算、对账与结算（需要权限与合规边界）；私链更适合单一机构内部账务、审计与流程系统。
