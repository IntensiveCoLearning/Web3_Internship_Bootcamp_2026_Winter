...
这也是web3目前除了炒作外金融属性强的一大原因，它诞生的初期就是一个“公共账本”。  
现在的 Web3 为什么全是金融、全是炒作？就是因为大家都想做“广场”，都在追求“流动性”和“网络效应”。因为广场人多，人多就能收税，就能发币割韭菜。而“日记本”是私密的、慢的、甚至不怎么赚钱的，难以冷启动的。  
回到上面的问题，在广场上，网暴是围观；而在“日记本“式的社群里，交互是点对点的、深度的。正如所担心的开盒问题，如果交互的出发点不是为了“出名”博取流量，风险或许会低得多。
