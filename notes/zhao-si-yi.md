...
今天根据那个pdf下载了open code。我预备做一个能播放bgm和图片和对话的东西。
<!-- DAILY_CHECKIN_2026-02-06_END -->

# 2026-02-05
<!-- DAILY_CHECKIN_2026-02-05_START -->

今天终于把021给看完了，虽然只是比较粗略地看了一点。不过终于把网络结构：节点、轻节点和归档节点搞清楚了一些
...
今天看了一些关于境外收入补税的文章，2018年之后开始了CRS程序之后完成了与相关国家的税务信息交换。到今年11月真的搞了几个案例杀鸡儆猴。文章总结说对小额的投资者的长期持有影响不大

另外又摆弄了一会儿speedrunethereum。
...
今天又摆弄了一会儿speedrunethereum，我能说取消狐狸钱包的链接就取消了半天吗？感觉快蠢死了。毕竟当初玩RPGmaker都搞不定战斗无法触发……
...
今天终于打开了speedrunethereum，虽然上次的remix还没搞清楚，但是先开启新篇章吧。
...
今天先做了简历修改，不过压根没什么可写的啊。

还看了b站公开课30分钟（区块链技术与应用），不过真的需要补一下密码学。哈希函数的部份真的没怎么听明白。
...
还有开始学日语，虽然感觉像在看鬼画符，但是非常有意思。希望以后能看梦野久作的原文
