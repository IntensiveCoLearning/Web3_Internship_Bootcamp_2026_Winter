...
<!-- Content_START -->
# 2026-02-12
<!-- DAILY_CHECKIN_2026-02-12_START -->
酷酷投简历
<!-- DAILY_CHECKIN_2026-02-12_END -->
...
也是实习计划的最后一天了，这里稍微作个总结:  
首先是遇到了很好很好的助教和同学，这一个月的时间非常地充实！

技术方面学会的东西还是不少的:hardhat,foundry,solidity然后还有一些dapp架构图(wachi老师画的那张真的很好)

也是参加了休闲hackathon的运营，学习使用了notion,figma还有还有如何去跟大家沟通协调，serena也是提供了很大的帮助。

未来的话我自己想着学习周老师说的打造个人的ip,另外我也去读defi协议的源码，精进自己的技术水平！
...
2.负责了workshop,co-building的策划文案
