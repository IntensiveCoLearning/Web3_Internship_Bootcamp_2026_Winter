...
在实习计划学到的知识必然宝贵，但是最开心的还是认识了很多很厉害的老师和朋友，有机会能上手做很多东西。因为在职的原因有些作业没有按时完成，但是会在未来的时间里用自己的节奏去2完成。感谢实习计划。
...
今天的分享会内容是技术向职业发展，又谈到了Vibecoding的话题，其实包括平时在日常工作里也会大量用到，但是共同的是，至少到目前，它也没法完全取代人类。我们可以通过使用工具变得高效，但对于一些内容本身的理解是大模型无法去取代的。
...
昨天请假了，然后再一次复习了Solidity的内容，看完了Openbuild上Web3数据分析的课程，加入了社群。收到了简历的反馈，确实很多事没人没法给我答案，我需要自己去探索。虽然学习的节奏可能更慢，但是没关系，脚踏实地把内容学扎实就好。
...
今天听了career方面的课，很喜欢老师最后说的，其实搞砸了也不会怎么样。是啊，其实什么时候开始学也都不会晚，只要有一颗想学习的心，随时都可以重新做选择。
...
今天晚上的两个分享内容各有特色，都非常充实，学到了很多，vibe coding其实不仅仅可以运用在web3领域，对我自身的工作也是有增益的（如果公司允许，笑死）。白丁老师讲话风格很风趣。他也提到，与其说去炒币/撸毛，还不如认真地接触一下web3这个行业，其实除了这些东西之外还有非常多可以精进、学习的地方。其实这也一直是我的想法。我从来不和身边人提起我参加了web3实习计划/在学习web3，因为我知道绝大部分人对于这个行业的认识仅仅就局限于炒币，但是我知道不是这样，事实上有太多值得我学习的内容了。别人的想法我无法改变，但是可以从自己做起，认真接触这个行业，哪怕没有基础和知识储备，学起来也更慢，相信只要持之以恒去付出时间和精力，我也一定能够入行，攒下经验，在这个更有前景的行业脚踏实地地走下去。
