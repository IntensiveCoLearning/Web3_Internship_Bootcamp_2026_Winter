...
禁止 ICO（首次代币发行）等。 因此：触及 Token 发行、融资、交易、矿池运营等高风险场景，便极易受到行政乃至刑事打击。

技术人员若**参与代币模型设计、空投逻辑配置、合约部署等环节**，也会被视为“共同行为人”，无法以“只是写代码”为由免责。

境内个人先用人民币购买 USDT、ETH 等虚拟币，再通过链上或境外平台兑换美元、欧元等外币，形成跨境资金流转链条。可能构成非法经营外汇业务。

### 全球监管背景：

FATF（Financial Action Task Force，金融行动特别工作组）是一个政府间组织。它是全球**反洗钱（AML）和反恐怖融资标准（CFT）**的制定者。

**Travel Rule（旅行规则）**是 FATF 对加密货币行业最重要的监管要求：

要求虚拟资产服务提供商（VASP）在转账时收集和传输发送方、接收方信息；适用于超过 1000 美元/欧元的转账

对 **DeFi 协议和 DEX** 提出了合规挑战

DeFi = Decentralized Finance**（去中心化金融）**：直接用区块链 + 智能合约来完成金融活动。

### 全球监管趋势：

**美国：**

SEC:将大部分代币视为证券进行监管;重点关注 DeFi 协议的证券属性;对 Coinbase、Binance 等交易所提起诉讼

CFTC：监管加密货币期货和衍生品；将比特币和以太坊视为商品

OCC：支持稳定币在银行体系中的应用；允许银行提供加密货币托管服务

**香港：**

VASP（虚拟资产提供商）制度：2023 年 6 月生效，要求加密货币交易所获得许可证；对零售投资者开放加密货币交易；要求平台实施严格的 KYC/AML 措施

### Web3入职风险：

**劳动合同关系：** EOR（名义雇主）模式，委托国内合规公司与员工签署合同。通过这种方式可以解决劳动关系里的部分问题，但在发生纠纷的情况下，劳动关系的认定仍然是需要关注的重点。

**薪酬结构风险：**Token币价波动

**出金风险：**员工通常需要通过“出金”将其兑换为人民币以满足日常支出。目前主流方式为 C2C 交易，包括场内挂单、场外担保交易、OTC 交易群等。**出金过程中极易卷入刑事风险。**在出金时，务必通过可信渠道进行出金，避免参与灰色交易，并定期留存相关资金合法来源记录，以便自证清白。

**项目合法性需提前审查：**是否面向中国大陆用户
