...
助记词 Seed Phrase: 私钥的可读备份

地址 Address: 公钥截取后的字符串，公开收款号
...
交易Transaction(tx)=你要做的事+手续费+防重放序号
...
三种切入方式：从Web2带能力迁移、从生态侧切入、建立链上声誉

-   开发：Solidity、Rust、合约安全意识
