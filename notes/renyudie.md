...
问题：岗位数量较少，行业内更青睐有更长时间工作经验，从传统互联网转型的产品，而不是从零开始培养的产品经理。对我来说如果能找到相关的实习经历积累经验，最好是能通过这样的项目转正。

### 运营

在web3行业中，运营是很大的一块，总体来说，门槛比产品略低。但依据公司及项目类型有不同的业务内容，有偏活动策划，增长类的，这类更要求marketing，策划，数据分析技能。还有一类则更偏向社群管理，客服。对我来说，如何主动探索，为自己找到合适的锻炼机会尤为重要。以及活动策划和复盘的能力，我在这方面还是缺乏主观能动性，应该更主动的向外探索。

### 数据分析

链上数据分析首先要求数据分析技能，如数据清洗，SQL语言，数据可视化等，同时也要求有分析，投研思维，这样才能在分析项目的时候知道怎样利用数据得出自己想要的结果。我的问题是我没有写过链上数据分析的报告，如果要求职的话，最好是积累一些相关的报告作为作品。

### BD

目前行业对BD的缺口较大，但大部分缺少的都是偏执行，销售性质的BD，对这样的工作更要求有销售经验，语言（英语或小语种）表达能力需要更出色。

## 拿到一个岗位后如何利用他实现快速成长

### 我的优点与缺点

学习能力和研究能力是我的优势，在沟通方面，我擅长用清晰的逻辑去表达和解释。因此，我认为我能够胜任大部分需要沟通和策划能力的工作（如运营），我有数据分析能力，也有数字技能，因此，产品或数据分析这样考验综合能力的工作对我来说更能体现价值。

### 岗位投递与面试阶段复盘

针对这段时间的岗位投递，我发现行业内区别其他行业的一些特点。

首先是产品经理，这类岗位几乎没有初级或实习的岗位大多要求五年及以上工作经验，没有带教制度，可能也是因为需要产品经理岗位的大多是交易所，加之岗位缺口本来就少，更偏向传统互联网经验。数据分析岗位也不多，一般来说普通项目和小交易所对数据分析的需求本来就不多，链上数据公开，意味着数据分析的门槛本来就不高，而规模不大的CEX更倾向于用一些ToB产品及运营人员来带代替专门的数据分析工作。最后是运营和BD，这两类工作是行业内缺口最大，对新手最友好的工作，但他的对技术的要求不高，更多关注的是社群活跃，语言好。在这两类工作的求职中，最好是尽力展现自己在这两方面的能力。

结合我自己的能力和经验，我认为更适合我的是产品运营，这类工作偏增长方向，与我的背景相符，同时也能作为我的理想岗位积累经验的一个跳板。

### 未来职业规划的思考

如果无法找到一份合适理想的产品运营工作，则转向更初级，门槛更低的运营实习工作积累经验
