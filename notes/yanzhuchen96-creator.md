...
在 2026 年的语境里，Web3 IP 不再只是“会写线程、会分享项目”，而是 AI 与 VC、交易、产品、技术、运营等多角色叠加后的综合体。社交媒体的热门账号上，每个人的简介都极度垂直：有人以十年加密 VC 身份切入，有人用清华+MIT+AI Builder 的标签立稳认知坐标，也有人从产品经理、早期交易者或学生社团主席的具体经历出发，让人一眼就知道“你在这个版图里的位置”。

**“如果 AI Agent 代替 80% 工作岗位，普通人还拥有什么？”** 对我来说有点像当头一棒，它逼我从职业技能的竞争，转向对“人本身还有什么不可取代”的思考。这个问题没有标准答案，但这让我意识到：在 Agent 能写代码、能研究项目、能生成内容的时代，人真正的筹码，很可能在于那些 AI 无法复制的东西。

**未来三年的核心公式：Web3 IP = AI Agent × 主体性 × 真实表达**。行业内容部分（60%）人类已经很难打赢 AI，但在策略判断、审美品味、情绪感知、认知结构和价值排序这些“主体性”的层面，以及把自己的人生经历、三观和普通人的真实感写出来的能力上，反而是我们可以构筑差异化的地方。信任、心理支撑和合作机会固然重要，可如果没有主体性和表达，关系也只是静态资源，不是活的 IP 护城河。

**“你想成为什么样的人？你想要什么样的人生？”** 这不是那种“你要年薪多少、要不要出国”的规划题，而是把 IP 建设拉回到最基本的 Agency——你在做选择时是不是清醒、是不是有自己的价值排序，而不是仅仅追着流量和热点跑。在这个视角下，个人 IP 不再只是对外展示，而是你对这两个问题长期回答的累积轨迹。

关于**“为什么要打造自己的超级 IP”**的部分：流量是短期的，IP 才是长期主义。个人的核心壁垒是“超级 IP × N 个行业”，这意味着你可以在快消、实体店、跨境电商、疗愈、心理咨询、人生教练等不同领域做探索，但真正贯穿其中的是同一个你、一套稳定而又持续演化的自我表达方式。“人生没有标准答案，找到属于你的人生答案”，这既是关于 Web3 和 AI 时代的竞争策略，也是对每个普通人如何在不确定中活出自己 Agency 的一次邀请。
...
从观众视角，这场分享给我的第一感受是：讲者不是在复盘一个“已经成熟的方案”，而是在带我们站在浪头上，看一个刚刚成形、边走边改的未来方向。 他一上来就坦白说这十天里 agent 和 AI coding “天翻地覆”，自己也没有完全成型的 Deck，而是想用更开放、互动的方式，帮助我们理解为什么这一波 AI/agent 的变化会远超以往的移动互联网和 Web 浪潮。

我能感到讲者的兴奋是有时间线支撑的：从早年读张朝阳、丁磊和 Linux/Unix 开源史，到在 Uber、Salesforce 做 AI，再到创办数据基础设施和新公司 Kaito，与大厂客户打交道。 他把这一段职业史当成一个长镜头，指向一个判断：当前这波 AI agent 的市场规模和影响力，将远远超过当年的互联网泡沫和移动浪潮，因此他愿意在去年就 All in 去做“agent + 支付”这个方向。

在讲具体产品前，他先用一个很生活化的例子解释自己为什么坚定看好“智能体支付”：他之前做的 browser-use agent 已经能帮他自动登录 Uber Eats 之类的网站做购物，但系统依然把登录身份当作“人类本人”，而且 agent 不能真正“花钱”。 在他的逻辑里，agent 是一个超聪明的开发者，天然不可能去填 14 行信用卡信息，它只会用 API 和“透明的钱”来执行任务，这恰好与链上身份和可编程支付的特性高度契合。 作为听众，我第一次清晰地感受到：区块链在这里不是为了炒币，而是为了让 agent 拿到一个可识别的 ID 和一个可信的“花钱媒介”。

让我印象很深的是他用“帮你办生日派对”来解释 agent economy：未来你只需要给 agent 一个预算和意图，比如预算 1000 美金、买蛋糕、邀请 15 个朋友、预订场地，剩下的搜索、比价、下单、发邮件和确认都交给智能体去跑。 他把这看作“agent 经济元年”的典型场景——所有繁琐细碎的事情由 agent 接管，人只负责给意图和边界。 在加密世界里，他又提到 agent trading 这个现成的高需求场景：让交易 agent 24 小时盯盘和下单，在他看来，这是目前最现实、最有营收潜力的一块市场。

Kaito 的核心产品愿景可以用“Agent Passport”概括：给每一个 agent 一个可验证的身份，让人敢把钱交给它代为执行任务。 他反复强调人不会轻易把 100 万美金交给一个不受约束的体，所以需要一套机制来约束 agent 的消费策略，包括充值方式、额度限制、允许访问的服务、可执行的交易策略，以及在“乱花钱”时可审计、可退款的流程。 在这一层，区块链既是资金托管和智能合约执行的基座，也是事后审计和纠纷解决的公共账本，让“先用后付”“满足条件才付款”等复杂支付逻辑真正可被 code 化。

### AI Coding 翻倍跃迁与开发者命运的“K 线图”

作为技术背景的观众，我对他讲的那段“AI 写代码比人快 50–100 倍”的案例感触特别深：同一个 4 万行、40 万行的系统，早期需要 6 个人一年半，现在一个人加上 agent 用两周就能重写出来。 他援引朋友在生产环境中的数据，说明从去年的“30% 能用”到如今 GPT-5.2 级别的“95%+ 可用”，AI 写的代码质量已经接近甚至超过普通 senior，开发者的工作逐渐变成“工程品味”和“设计审美”的决策者，而不是一行行实现 for/if 的苦工。 他说 CS 学生会被拉成一张“K 线”：junior 可能被淘汰，顶级 developer 借助 agent 会被放大成 10x/100x 产能，这种残酷又真实的判断让人既紧张又兴奋。

分享中最“炸裂”的观点之一，是他直接说“RAG is dead，MCP 很快也要被淘汰”，理由是模型本身变得足够强，复杂的向量检索和工具协议反而成了累赘。 他举例 Cloud Code 的做法：把短期记忆和长期记忆直接写成文件，用 file system 和 agent search 来查找，而不是折腾 embedding 和向量库；工具调用也直接通过命令行和代码执行，不再绕 MCP 的 JSON 包装。 对我这样的听众来说，这等于在提醒：过去一年刚学会的一套“RAG + MCP 最佳实践”，很可能会在新一轮范式中被整体重构，真正要追的是“模型能力 + 系统设计”的组合，而不是停留在某个框架名词上。

### 人在 Agent 时代还能做什么

在问答环节，很多问题都是围绕“那人还有什么竞争力”“会不会被 AI 全面取代”等焦虑，他的回答让我感觉既现实又带一点个人哲学。 他认为，AI 无法取代的是人的需求、兴趣和审美——无论是对某个交易市场的深度热爱，还是对某个技术方向的长期钻研，这种“愿意天天自发起床继续折腾”的状态才是顶尖人才的共性。 代码实现本身会越来越工具化，人应该把注意力从刷题和 DP 算法上移开，转向架构设计、领域理解和产品方向，而创业本质上就是个人强烈需求和意志的外化，这部分 AI 很难替代。

临近尾声，他用“人类支付 vs agent 支付”的对比，把 Kaito 想做的闭环又梳理了一遍：传统支付是人自己挑选商品、下单、付款，系统只解决从 10 美金到 1 万美金的中等客单价，无法支撑大规模微交易，更无法让 agent 自主刷信用卡。 在他设想的 agent payment 流程里，用户先给出 intent 和预算，agent 再进行搜索、比价和选择，每一步都有对应的 invoice 和条件，最终通过链上智能合约完成付款，所有步骤可被验证和审计。 作为观众，我能感觉到这不仅是一个产品方向，更像是在重写“支付协议”：从“人对平台”的交易，转向“agent 对服务”的透明交互，中间的平台权力被弱化，信任更多地交给代码和公开规则。
...
## **分享会：走进 Web3 DevRel 一线**

这份分享一开始把 DevRel 定义成连接产品/工程和外部开发者生态的“桥梁”，核心工作是通过技术赋能和社区互动，促成双向的价值流动。 DevRel 可以是独立部门，也可以挂在产研下面：独立时更偏生态增长、决策链路更短、跨部门用资源更灵活；归属产研时则技术理解更到位、和产品迭代节奏强绑定，并且能直接影响 SDK/API 的设计和优化。 在具体岗位上，一个完整的 DevRel 团队会涵盖技术布道师、社区经理、技术写作、DevRel 工程师、解决方案架构师、生态增长负责人、项目经理、开发者营销、黑客松负责人和数据分析师等不同角色，共同服务同一条“开发者旅程”。

在 Web3 语境下，DevRel 的本质被总结为“持续的、双向的、增值的连接”，对应四个关键任务：倾听与反馈、赋能与教育、生态与连接、影响与增长。 倾听与反馈意味着要搭建反馈通道、做竞品分析和用户调研，把一线开发者的真实声音带回产品；赋能与教育则通过完善文档、课程和 Workshop，把复杂的链上开发门槛尽可能压低。 生态与连接是把合作伙伴、集成方和开发者社区织成网络，让资源流动起来；影响与增长则通过 Hackathon、大型活动和成功案例，放大品牌声量、推动业务指标和生态规模。

演讲专门用一课讲“MVCS（Minimum Viable Content Stack）”，把它看成开发者体验的地基——目标很直接：让开发者在 5 分钟内跑通一个 Example。 这个“最小内容栈”包含 Quick Start 接入指南、开箱即用的示例仓库、覆盖常见错误和疑问的 FAQ、架构与安全的最佳实践和红线、从老系统迁移与集成的指南，以及详尽的 SDK/API 文档和调试工具。 站在听众视角可以感受到，这套栈其实是在回答一个问题：当一个新开发者第一次点进链上文档，如果在 5 分钟里踩不完坑、跑得通 demo，就很可能留下来继续建东西。

在更细的层面，分享把 Quick Start、示例仓库和 FAQ 当成 DevRel 手里的“乐高盒子”，用来降低上手成本。 通过脚手架矩阵可以一键生成基础项目骨架，配合 JS/TS、Go、Rust、Python、Solidity 等多语言支持，以及围绕 NFT Mint、DeFi Swap、DAO Voting 等场景的 Demo，让开发者可以直接“拼装”出一个能跑的应用。 FAQ 部分则通过错误码索引和易检索的内容设计，帮助开发者在卡住时快速自助解堵，从而减少对人工支持的依赖、提升整体体验。

### 架构安全、迁移集成与 SDK 模板

为了让开发者不仅“跑得起来”，还要“跑得稳”，文档还要覆盖架构安全和迁移集成等更深一层的主题。 在架构与安全部分，团队会提供高可用、高并发的参考架构图，并明确私钥管理、鉴权机制、防攻击策略等安全红线，帮助开发者避免常见致命错误。 在迁移与集成上，他们给出从 Javascript 生态到 Solidity、从 Hardhat 到 Foundry 的迁移路径，同时提供包括 Scaffold-Eth-Monad、Hardhat Starter、Foundry Starter 以及多种钱包 + 支付/Swap 组合的 SDK 模板，让不同背景的团队都能找到适合自己的入口。

这场分享的一个亮点是对 DevRel 成效的量化思路：把 MAD（月活跃开发者数）作为“北极星指标”，用来衡量生态整体的繁荣度；同时用 TTHW（Time to Hello World）作为“护城河指标”，衡量开发者体验是否足够顺滑。 其他指标如 Docs Conversion（从看文档到注册/调用 API 的转化率）、POC -> Prod 转化率和 Issue Close Rate 则从转化、商业和服务三个维度补足了 DevRel 的全貌，让“写文档、办活动”不再只是软性工作，而是可以用数据回看影响力的系统工程。

### 生态与社区从 0 到 1 的节奏

在生态建设上，这份材料强调从 0 到 1 时要先把“人”和“价值”讲清楚，再设计稳定的触达节奏。 目标画像包括 Early Adopters、Builders 和 Degens，不同群体被吸引的价值主张可能是技术先发优势、Grant 激励或个人影响力的提升。 运营节奏则被拆成 Daily 的 Discord 答疑、Weekly 的 Office Hours 和 Dev Updates、Monthly 的 Newsletter 与技术深潜，以及 Quarterly 的 Hackathon 或重大版本发布，外加一条从 User 走到 Partner 的贡献阶梯，帮助社区成员循序渐进地升级自己的参与度。

在具体活动形式里，Hackathon 被视为“引爆开发者创造力的最佳场域”，需要在赛道选择、预热、比赛和产出期都做好设计，并通过 Grant、孵化器和投资机构推荐把优秀项目留在生态里。 Workshop 则承担着“深度转化”的职责，通过 10 分钟介绍 + 40 分钟 Live Coding + 10 分钟 QA 的结构，再结合云端开发环境、Starter/Final 分支管理、合适的助教比例和现场小激励，让每个参与者都能带着一个实打实跑通的 Demo 离开，而不是只听了一场抽象的宣讲。

### DevRel 所需的硬技能与软素质

最后，分享用硬技能和软技能的分层模型勾画了一个成熟 DevRel 的画像：在技术层面，不要求每个人都写生产级代码，但至少要能读懂 SDK 文档、跑通 Hello World，逐步进阶到会 Debug 常见错误，甚至理解底层共识、执行和存储原理；同时具备把复杂技术翻译成“人话”的写作与信息架构能力，以及构建高质量 PPT 的能力。 在软素质上，DevRel 被要求有强同理心和沟通能力，能在内部扮演开发者代言人，也要擅长在“没有正式权限”的条件下跨部门协作、管理预期、撬动资源，并具备节奏感强、优先级清晰、善于闭环的项目管理能力。

### Monad 背景与开发者机会

作为落点，这份介绍也简要说明了 Monad 本身的技术定位：从零开始重新设计、完全等同于 EVM 的 L1，高性能（约 10,000 笔交易每秒、400ms 区块时间、单 Slot 最终性）、支持较大合约尺寸，同时保持去中心化和与以太坊 RPC、Metamask、Etherscan 的无缝兼容。 在此基础上，团队列出了包括 MONAD BLITZ 系列、evm/accathon 以及 Rebel in Paradise AI Hackathon 在内的一系列全球开发者活动，并配合中文开发者官网、社群和推特渠道，向潜在开发者发出“来一起玩、一起建”的邀请。
...
Web3 媒体的定位主要分成三块：信息分发、市场教育和价值发现。 信息分发指的是把各交易所、项目方、KOL 以及链上动态等前沿信息聚合后再输出，为圈内投资者、交易者和圈外新手都提供一个低门槛的入口，尽量缩小信息差。 市场教育则面向对 DeFi、协议机制不熟悉的人，通过拆解协议、解读数据和梳理事件前因后果，帮助他们建立基础认知。 价值发现是基于多交易所、多赛道、多币种的广覆盖，持续追踪资金流向、赛道热点和社区情绪，给出哪些赛道和协议可能有潜力，从而减少投资者错过 Alpha 的概率，这一点与交易所更多做“价格发现”有所不同。

## 与传统金融媒体的差异与挑战

相较传统金融媒体，Web3 媒体所处的是一个 7×24 小时、全球化、无国界的市场，事件从发生到发酵的周期可以缩短到秒级、分钟级。 信息来源也从传统的公告和监管文件，扩展到链上数据、社区治理、社交媒体发言等高度碎片化的素材。 真正的难点不在“拿到信息”，而在如何从极度透明又噪声巨大的信息流里抽丝剥茧，筛掉情绪、谣言和误读，形成稳定的逻辑框架与个人认知，而这恰恰是 Web3 媒体从业者的核心功底。

## PANews 记者的日常工作流

PANews 的一天从 9:30 的晨会开始，运营和记者会把前一日加夜间的全球信息做一次“口头聚合”，有价值的内容会被筛选出来做快讯或者成为潜在选题。 晨会后，记者会围绕市场热点或自己观察出的结构性变化来选题，与主编确认价值之后才开写，这一步往往在市场冷清时最耗时间。 之后是多信源的信息收集和采访，确认数据与事实，再用约一天左右完成写作、交由主编和副主编编辑审核，整体从立项到上线常规节奏是两天一篇，熟练的编辑可以压缩到一天，但前提是经验积累足够扎实。

## 信息入口、工具与素材管理

在信息入口优先级上，推特（X）是整个 Web3 圈的第一现场，不论是项目方、交易所还是 KOL，重要信息几乎都会首先在那里出现，因此对想入行的人来说也应是首选学习阵地。 第二层入口是各类 TG 群与 Discord 社区，以及 The Block、CoinDesk、Cointelegraph 等媒体站和 Dune、Arkham、Nansen、CMC、CoinGecko、DeFiLlama 等数据/行情站，用来系统性补齐与验证信息。 在内部协作层面，他们主要使用 TG 与 Notion 来沉淀晨会内容与素材，用 Google Docs 进行写作与多人批注，而在 AI 工具上，既会使用能对推特内容进行聚合的产品，也会用 ChatGPT 这类工具拆解问题、收集初步素材，但强调要优先选择能给出引用索引、可回溯原文的工具。

## 事实核查、热点直觉与信息梳理

在真假难辨的环境里，PANews 把“don’t trust, verify”当成铁律：任何重要信息都要经过项目方官方渠道、链上交易记录以及相关机构评论的多源交叉验证，必要时还会直接在推特私信当事人确认。 Jae 特别强调了 AI 幻觉和伪装账号的风险，比如假冒官号发布合并或融资消息、伪造数据等，因此媒体宁可牺牲一点速度，也不能牺牲准确性，这也是与部分只追流量的个人账号最大的分野。 至于“为什么媒体总能抓得准热点”，他给出的答案是日复一日高强度的信息浸泡——每天至少数小时在推特与各大媒体上“冲浪”，长期下来会自然形成对真假信息和市场关注点的直觉，这种直觉无法通过捷径获得。

## 写作风格、采访方法与 AI 辅助边界

在写作层面，媒体稿件既要客观中立、基于事实，又要有故事性和可读性，避免变成“喊单文”或生硬的 PR 稿。 为了降低理解门槛，他们会多用类比、分层解释与举例，并尽可能用图表来承载复杂数据，做到“有图不用表，有表不用字”。 采访时，前期需要对项目技术架构和背景做深度研究，但在现场提问时更重视从读者能听懂的角度，围绕技术带来的优势、效果、争议点、数据表现与最新进展发问，并留出空间去问挑战性问题，从而挖掘对方真实的思考而不是只是念 PR 台词。 对 AI 的态度是“高频使用，但保持警惕”：它适合做信息拆解和素材聚合，却仍然缺乏判断选题价值的直觉、宏观叙事的审美和真实的人际网络，因此人不能被 AI 驯化，反而要通过多读优质媒体与经典作品，持续打磨自己的眼光与文感。

## 入行 Web3 媒体的路径与必备能力

对于想进入 Web3 媒体或运营岗位的人来说，最重要的履历不是一页简历，而是你在推特上持续可验证的输出记录——包含基于数据的观点推文、长 thread 或文章，这些都可以作为个人 IP 与专业度的直接证明。 新人可以从每天几条短推文开始，围绕项目数据、赛道趋势做简单解读，在保证事实准确的基础上逐步练习故事性和可读性，再慢慢过渡到长文创作。 除此之外，快速学习能力、信息甄别和数据解读能力、对 DeFi 与 Tokenomics 的基础理解、良好的英文读写和口语、对活动的积极参与（线上 Space 和线下会议）以及愿意主动社交、建立行业人脉，都是在这个行业里长期走下去的关键技能。
...
简历在Web3行业根本不是法律文件，也不需要写得像法院判决书那样死板。核心追求的是视觉清爽和信息高密度，强烈建议控制在一页纸以内。很多人被“3年经验”的招聘要求吓退，但这个门槛在高速迭代的币圈其实很虚：如果你有半年高强度、深度的实战产出，比如一份扎实的协议拆解报告、核心代码贡献、或链上数据深度分析，资历的数字差距完全可以被忽略。大胆投递才是关键。尤其投VC或研究员岗位时，一份Solid（扎扎实实）的深度项目拆解报告，杀伤力远超精修过的简历。通过写长文、发Thread建立影响力，很多时候是项目方或投资人先主动找到你，而不是你苦等面试。

## 技术栈选择与高效学习路径

当前Web3底层最吃香的语言是Rust和Go，两者几乎是刚需。Rust虽然陡峭，但Solana、以太坊生态高性能部分离不开它；Go则在交易所、后端基础设施中极其通用，建议优先补齐。学习方式上，抛弃传统“报班+看文档”的低效路径。现在最快的成长是直接用AI（Cursor、Claude等）拆解GitHub上顶级开源项目的代码，特别是安全逻辑和资金流向的梳理，这种方式比死记文档有效十倍。实战导向永远优于系统课程：扒代码、查链上数据、进社区直接找核心开发者聊，才是这个行业最短的认知迭代回路。

## Web3行业的底层真相与赚钱逻辑

现在的Web3很像“柴火棍”堆起来的房子：UI差、体验烂、安全隐患多，整体处于非常早期且混乱的状态。但也正因如此，这里才存在巨大的套利空间和阶层跃迁机会。用户对产品的容忍度极高，只要能赚钱，前端卡顿、手续费贵、交互十几个步骤，他们照样挤破头使用——赚钱效应永远是第一生产力。这决定了产品逻辑和传统Web2完全不同：不要过度追求优雅和极致用户体验，先跑通“赚到钱”的闭环才是王道。

## 不同岗位的真实生存状态

交易所 > 顶级项目/VC > 媒体，是目前食物链相对清晰的排序。交易所处在资金流最顶端，抗风险能力最强；媒体入门最容易，但也最容易沦为流量工具，竞争白热化。社区运营（CM）远不止发推和聊群，核心是情绪管理和共识维护：你需要直面用户最赤裸的贪婪与恐惧，尤其币价剧烈波动时，社区就像情绪的压力锅，需要极高的心理素质去“量子叠加”——既共情又抽离。产品经理（PM）则面临从“反人性”到“降门槛”的历史性机会：谁能把Gas费、助记词、链上交互藏到像微信一样丝滑，谁就掌握下一代Web3产品的钥匙。

## 零经验 / 跨行者的造血策略

背景是可以“造”出来的，不要等机会砸到头上。立刻能做的动作包括：参加黑客松（哪怕不获奖，经历就是金子）；给开源项目提交PR（哪怕只是改文档或翻译）；在Twitter发深度Thread、在Discord持续贡献价值。这些记录比任何名校文凭都硬。从小团队（3–5人）起步反而更好，你有机会经历从写代码、做运营到跑市场的全链条，这种“全栈”经历在Web3极具竞争力。简历写法也要“去法律化”：少写长篇自我介绍，多用数据和Proof of Work说话，比如“拆解过5个主流协议”、“发现并报告1个安全漏洞”、“社群活跃度提升30%”。

## 非线性的人生与行业底层心态

Web3的职业曲线是非线性的，不是传统大厂的线性爬升，而是“跳跃式”跃迁。你可能因为参与一个爆火项目、或写出一篇全网疯转的研报，在半年内完成别人十年的认知和财富积累。但前提是必须一直在场，接受极高的不确定性和“脏乱差”。运气很重要，但运气只给已经在桌上玩牌的人准备。建立一个让人记住的“长板”标签（Rust专家、链上数据高手、深度研报作者）远比做全才更有价值。同时要保持清醒：行业有很多灰色地带，守住资产安全和链上逻辑的底线，才是长跑的生存前提。

## 认知速度就是终极竞争力

在这个极度透明又极度复杂的信息场，认知领先别人10分钟就能产生溢价。主动拥抱Permissionless（无许可）打法：不要等HR邮件，直接在Twitter私信创始人、在Telegram展示研究成果。英语是刚需，一手Alpha信息几乎都在英文社区；中文圈想快速出头，最有效的方式是用中文把英文硬核内容“降维”输出，制造信息差打击。最终活下来的人，不是最聪明的那批，而是执行力最强、愿意拥抱混乱、并持续产出作品的那批。
