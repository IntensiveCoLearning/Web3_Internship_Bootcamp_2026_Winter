...
这份笔记基于《Web3 实习计划（冬季）：南塘 DAO 主题分享》视频内容整理。视频由南塘 DAO 的三位核心成员（小白、燕人、富章）主讲，详细介绍了如何将 Web3 的治理逻辑与中国乡村建设相结合，特别是引入了“栈”式议事逻辑来解决共识难题。

* * *

### **第一部分：嘉宾分享部分**

**1\. 乡村建设的痛点与 Web3 的定位 (小白)**

-   **痛点**：乡村项目往往“铁打的南塘，流水的年轻人”。经验难以继承，关系难以维系，且大量的“情感劳动”和“协调沟通”无法被量化记录。
    
-   **Web3 角色**：区块链在南塘不是主角，而是\*\*“工具箱”\*\*。它将模糊的付出变成可记录、可追溯的“链上故事”，通过任务记录和行动痕迹，让个人的贡献被看见。
    

**2\. “栈”式 DAO 提案处理流程 (富章 - 核心干货)**

南塘 DAO 引入了基于“罗伯特议事规则”的 **iMeeting** 治理工具，其核心是一个类似计算机数据结构中\*\*“栈”（Stack）\*\*的逻辑：

-   **压栈 (Push) - 动议嵌套**：
    
    -   当一个“主动议”（如：办艺术营，预算 6 万）提出后，如果有人反对或建议修改，就会产生一个“修正案”（如：建议预算改为 4 万）。
        
    -   这个修正案会被“压”在主动议之上。如果有更细节的修改（如：4 万中必须包含村民补贴），会继续向上压栈。
        
-   **栈顶优先原则**：
    
    -   会议必须**先讨论栈顶**的议题。在“4 万预算行不行”没定论前，严禁跳回去讨论“要不要办艺术营”。
        
    -   这强制了讨论的聚焦，防止了 Web2 会议中常见的“甲在说预算，乙在说时间”的思维发散。
        
-   **出栈 (Pop) - 逐层表决**：
    
    -   表决是**自上而下**的。先表决最顶层的修正案，通过后，原来的主动议自动更新为被修正后的内容。
        
    -   只有清空了上层的修正案，才能最后对完整的主动议进行总表决。
        
-   **价值**：保护少数派和“不成熟”的想法。反对者不能只说“不行”，必须提出修正案（压栈）来完善提案，让冲突在规则层解决。
    

**3\. 艺术共创营的实战验证 (燕人)**

-   **从独断到共识**：燕人分享了从“画院式”领导（一人说了算）到 DAO 模式（全员议事）的阵痛。
    
-   **成果**：通过上述“栈”式规则审核预算，南塘 DAO 成功举办了艺术共创营，产出了《种子的想象》等作品，并将第一期志愿者成功转化为第二期的运营者。
...
-   **数字身份**：开发了“南塘数字身份”网页包，支持村民用**手机号直接注册**，无需掌握复杂的私钥管理。
    
-   **南塘豆 (NT)**：在以太坊 L2 (Optimism) 上运行，作为“故事账本”。村民通过劳动获得 NT，可在社区超市兑换花生、姜酒或冲抵住宿费。每笔兑换必须在链上写下“备注故事”。
    

**2\. 官方对这种“去中心化”的态度如何？**

-   嘉宾表示南塘 DAO 严格界定为\*\*“记账技术”\*\*。NT 代币不与法币挂钩，仅作为社区积分。与团委等部门的合作主要集中在具体活动的报备，强调技术是为“记录贡献”和“民主议事”服务。
    

**3\. DAO 如何实现经济闭环与可持续性？**

-   **现状**：目前仍高度依赖资助人，国库存在压力。
    
-   **未来模型**：计划将“共创营”治理模式产品化。不仅卖农产品，更要向其他组织\*\*“卖治理服务”\*\*，帮助其他社区设计营队和积分流转机制，从报名费中抽成实现分润。
    

**4\. 激励机制的本质是什么？**

-   核心不是 NT 豆的经济价值，而是\*\*“被看见”\*\*。通过透明的链上记录，让村民和志愿者的付出（哪怕是打扫卫生）被永久记录并得到尊重，这种认同感是 DAO 凝聚力的来源。
    

**💡 专家总结笔记**：南塘 DAO 是 Web3 在中国最硬核的“地面实践”之一。它利用**栈式逻辑**将冰冷的程序正义引入温情的乡村人情社会，证明了区块链最大的价值不在于发币，而在于重塑一套公平、透明且可追溯的**生产关系记录仪**。
