...
今天参加了结营仪式，听到了很多小伙伴在这段实习计划中的故事和成长，感触很多。本次实习计划中，技术方面，我完成了大部分入门技术的任务和课程要求，对基本的Solidity开发、Remix、Hardhat和Foundry等测试部署工具的使用都有了基本概念。
<!-- DAILY_CHECKIN_2026-02-08_END -->

# 2026-02-07
<!-- DAILY_CHECKIN_2026-02-07_START -->

今天参加了LXDAO的周会并做了自我介绍，正式加入了LXDAO。在会中，我对Swen同学的EIP Playground很感兴趣，我个人是很喜欢这种 learn by doing 的学习理念，但是Bruce老师也提到了LXDAO之前的类似项目反响不好。我的理解是，作为个人项目，我是很支持这种布道者项目的；但是作为DAO组织，应该要考虑到投资回报率，不能盲目投入到一些偏理想主义的idea中
