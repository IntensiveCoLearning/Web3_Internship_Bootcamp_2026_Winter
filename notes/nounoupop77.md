...
Web3媒体核心价值：信息分发、市场教育、价值发现，既是行业流量入口，也是减少信息差、挖掘资产潜力的关键角色。

二、与传统金融媒体差异

• 特性：7×24小时、全球化，事件催化达秒级/分钟级

• 信息来源：以链上数据、社区动态为主，更碎片化、易过载

• 核心挑战：从海量噪声中快速剥离事实与逻辑

三、工作流程（以PANews为例）

1\. 09:30 晨会：分享全球Web3重要信息，筛选快讯/选题线索

2\. 选题立项：与主编讨论确定有价值选题（冷市场可能耗时数小时）

3\. 信息核实：多信源交叉验证，必要时采访确认数据

4\. 写作打磨：8小时左右完成，风格简洁易懂，兼顾逻辑与可读性

5\. 审核发布：主编/副主编审核（1-3小时）后上线，常规周期2天/篇

四、关键工具与信息入口

1\. 信息入口优先级

• 第一：Twitter（X），信息流动最快，灵感主要来源

• 第二：TG（项目/交易所/KOL群，协作+沟通）

• 补充：The Block（媒体）、Dune/Arkham/Nansen（数据）、CMC/CoinGecko（行情）

2\. 协作与写作工具

• 协作：TG+Notion（内容沉淀+需求提报）

• 写作：Google Docs（批注修订流）

• AI工具：ChatGPT（拆问题/梳素材），优先选带引用索引的类型

五、核心工作原则

1\. 事实核查：don’t trust, verify，交叉验证项目方、链上记录等多渠道

2\. 避坑重点：警惕AI幻觉、伪装账号（假融资/假数据）
...
• 方法：用类比/举例/图表降低阅读门槛，兼顾故事性

2\. 采访要点

• 前期：深入研究项目背景、数据表现、争议点

• 提问：聚焦技术优势、实际效果，设计开放式+挑战性问题

七、AI使用边界

• 优势：提升素材梳理、问题拆解效率

• 局限：缺乏直觉、审美、宏观判断与人际信任构建能力

• 建议：不依赖，用其做基础工作，保留自身思考与表达训练

八、入行必备技能

1\. 内容能力：从短研究推文起步，逐步积累长文创作经验

2\. 个人IP：在Twitter持续输出可验证的观点与数据解读

3\. 通用能力：快速学习、信息甄别、数据解读、基础DeFi/Tokenomics认知、英文沟通

4\. 运营侧：网感，学习“疯狂实习生”等账号的热点运营方式

九、重要提醒

• 入行证明：Twitter内容沉淀是核心“作品集”，熊市耐住寂寞积累

• 信息梳理：无捷径，需勤劳整合多平台非重复信息，会编程可提升效率

• 岗位机会：PANews招运营实习生，JD可联系获取

需要我帮你把这份笔记整理成可直接打印的PDF格式，或提炼成1页精华思维导图吗？
