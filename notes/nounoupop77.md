...
结营了！这个为期一个月的共学营学到了很多东西，我十分感激。

学习了solidity的基础，运营宣发，nft，uniswap，还有很多机会和活动帮我巩固知识点，加强我对他们的认知，这是一个特别好特别完美的平台。

每一个人在这里都尽心尽力，搭建，維護，完善這個平台，我除了感激還是感激。

也該對未來有更明確的方向了，該再出發了，由衷謝謝大家，祝大家越來越好
<!-- DAILY_CHECKIN_2026-02-08_END -->

# 2026-02-07
<!-- DAILY_CHECKIN_2026-02-07_START -->

学了 Cyfrin Updraft 上的 Uniswap V2 课程

-   Uniswap V2 遵循 x\*y=k，创建新交易对池子的话，首次创建必须同步初始化初始流动性，不能单独建池。
    
-   要先确认满足 Factory 的创建要求，再设置交易对代币的初始配比，最后部署并初始化流动性池合约，建池和首次加流动性是绑定的，一步都不能漏，稍有不慎合约调用就会失败。
...
今天翻看前段時間hardman的黑客松分享，做了一些笔记。

ClaudeCode & VibeCoding 核心要点笔记

一、核心概念

• VibeCoding：以 ClaudeCode 为代表的 AI 辅助编码模式，其核心能力是上下文管理。

• 把 AI 协作比作“骑马”：目标（需求）不明确就会绕路，不及时修正方向（打断 AI）就会偏离，不提供上下文“养料”表现就会变差，不做好标记就会迷失在代码中。

二、上下文管理关键方法

1\. plan mode：先规划整体开发流程，再进入编码。

2\. 勤看 context：随时回顾对话历史，确保信息连贯。

3\. /compact：用命令压缩冗余对话，保持上下文简洁。

4\. 多与 AI 请教：主动让 AI 发现问题，提前暴露风险。

三、ClaudeCode 系统架构

基于 MCP/Agent/Skill/Plugin 四层插件系统：

• Plugin：负责功能分发，是与外部交互的入口。

• Agents/Skills/MCP：分别对应执行单元、能力模块和核心协议。

• 该架构支持灵活扩展，能整合各类工具和能力。

四、实用技巧延伸

• UI 优化：可借助 [asistudio.google.com](http://asistudio.google.com)、[replicate.com](http://replicate.com) 等工具生成素材，提升视觉效果。

• 进阶技巧：参考《Advent of Claude》中整理的 31 条核心开发者技巧，可显著提升使用效率。
...
今天參加了Web3媒體工作的分享會筆記，學到了很多東西！

1.  Web3媒體核心價值是資訊分發、市場教育、價值發現，既是產業流量入口，也是減少資訊不良、挖掘資產潛力的關鍵角色。
    

2.  與傳統金融媒體差異在於：
    

• 特性：7×24小時、全球化，事件催化達秒/分鐘級

• 資訊來源：以鏈上資料、社群動態為主，更分散、易過載

• 核心挑戰：從海量噪音中快速剝離事實與邏輯

3.  工作流程大概為：
    

1\. 09:30 晨會：分享全球Web3重要訊息，篩選快訊/選題線索

2\. 選題立項：與主編討論確定有價值選題（冷市場可能耗時數小時）

3\. 資訊核實：多信源交叉驗證，必要時訪談確認數據

4\. 寫作打磨：8小時左右完成，風格簡潔易懂，兼顧邏輯與可讀性

5\. 審核發布：主編/副主編審核（1-3小時）後上線，常規週期2天/篇
...
• 第一：Twitter（X），資訊流動最快，靈感主要來源

• 第二：TG（專案/交易所/KOL群，協作+溝通）

• 補充：The Block（媒體）、Dune/Arkham/Nansen（數據）、CMC/CoinGecko（行情）

2\. 協作與寫作工具

• 協作：TG+Notion（內容沉澱+需求提報）

• 寫作：Google Docs（批註修訂流）

• AI工具：ChatGPT（拆題/梳素材），優先選帶引用索引的型別

5.  核心工作原則
    

1\. 事實查核：don’t trust, verify，交叉驗證專案方、鏈上記錄等多管道

2\. 避坑重點：警惕AI幻覺、偽裝帳號（假融資/假資料）
...
• 方法：用類比/舉例/圖表降低閱讀門檻，兼顧故事性

2\. 訪談要點

• 前期：深入研究計畫背景、數據表現、爭議點

• 問：聚焦技術優勢、實際效果，設計開放式+挑戰性問題

AI使用邊界

• 優勢：提升素材梳理、問題拆解效率

• 限制：缺乏直覺、美感、宏觀判斷與人際信任建構能力

• 建議：不依賴，用其做基礎工作，保留自身思考與表達訓練

7.  入行必備技能
    

1\. 內容能力：從短研究推文起步，逐步累積長文創作經驗

2\. 個人IP：在Twitter持續輸出可驗證的觀點與資料解讀

3\. 通用能力：快速學習、資訊甄別、資料解讀、基礎DeFi/Tokenomics認知、英文溝通

4\. 運營側：網感，學習「瘋狂實習生」等帳號的熱點運作方式

ps：

• 入行證明：Twitter內容沉澱是核心“作品集”，熊市耐住寂寞積累

• 資訊整理：無捷徑，需勤勞整合多平台非重複訊息，會編程可提升效率
