...
今天深入研究了一下Dapp,准备着手去做一个自己的Dapp

开始尝试写自己的Dapp，目前进度还在检索器开发
...
2.学习了很多新的知识，比如hardhat和一些solidity的基础

3.将合约部署在sepolia测试网中，但是一直卡在挖矿这里，导致部署的时候gas不足
