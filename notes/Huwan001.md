...
今日是較少看到的媒體崗位，其中老師有提到小白如何在初期去訓練自己的文字能力，堅持創作，不需把標準設得太高，但固定產出是很重要的。對於行業要有敏感度，撰寫的資料可以是二手，但不要寫一些空穴來風的假消息，雖然盡量還是一手消息好。當然外語能力還很重要的，許多一手消息都是英文圈，不一定要能夠懂，但敏銳度還是要有的，可以搭配AI去做整理，分析客觀看法。多找一些大媒體，比如老師的_PANews，_多看，多分析它們是如何下手、如何分析的，分析架構，帶著問題去閱讀，嘗試將這些手法內化到自己身上，鍛鍊網感
