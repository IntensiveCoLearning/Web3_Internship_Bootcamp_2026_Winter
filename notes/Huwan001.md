...
今日是實習計畫最後一天了，沒有想過自己能堅持到今天呀，這段時間每天都過得非常充實，但中間有幾日水了筆記，一開始覺得自己的能力很不足，但經過這個月，不只是學到了非常多，也認識了許多小夥伴，每個人的經歷背景都不同，如果沒有實習計畫肯定是不可能走到一塊的。

認識了大家，我真的很感謝當初下定決定報名這個實習營的我自己，雖然後面的學習進度挺跟不上的，但比起在加入計畫之前整日都在網上亂找資源、瞎子摸象的時候，這次的開源教材、每日的課程安排，都是具有完整學習資源，讓我在結業後還是能夠反覆觀看去做學習的。

今日參加結業儀式，聽著各位同學的分享，回顧起這四周的日子，一幕幕回顧在腦海中，大家的心得、學習歷程可能都不盡相同，但聽著感受也是非常深刻的。最後的環節看著各位老師們的稱號，也真的感受到每位老師都是花費非常非常多的心力在建設這次的營隊計畫。

辛苦各位老師，也感謝各位同學，未來我們也能夠攜手走向更繁榮的 Web3，感謝 ETHPanda、LXDAO提供這次的機會，讓我有更多接觸這個領域、認識未來行業大佬的機會 ! (完結灑花
...
今日參與 Space 聽各位老師在 Web3 的相關歷程，蠻輕鬆但挺真實的。

各位老師在這條路上都已經付出了許多，不管是精神上還是身體上的，雖然我還沒有跨入這個圈子，但在我現在的環境中也能感受到類似的情況，雖說有努力不一定有結果，但不努力一定沒結果，以各位老師為榜樣繼續堅持努力下去，想著還有這麼多比我厲害的大佬前輩們都還是這麼努力在耕耘，我也要加倍努力追上老師們的腳步 !
...
傍晚參與線上共學時聽ECHO老師分享了一些感情的內容，大家也討論了起來，感覺大家對這部分都是蠻有自己的看法的，在交流的過程中也收穫了不少，感受到情感也是一門需要花很多時間去學習的課題

下午參與美麗老師分享的BD工作日常，老師本人是非常有趣的，聽到分享蠻多有趣的事情，但還是覺得需要頻繁去參加展會啥的很吃個性呀，社交這部分對於內向的人來說真是一門需要花很多時先去修的課呀 !  
偷偷表白一下美麗老師真的很漂亮呀

**1\. BD 的本質與定位**

-   BD 本質是 **ToB 的銷售與價值交換角色**，核心目標是 **營收（revenue / GMV / deal）**
    
-   跑會、建聯只是手段，不是目的
    
-   BD 是理解產業全貌、產品需求與市場結構的高效率入口角色
    

**2\. BD 的成長階段**

-   初期：個人作戰，負責建聯、找線索、推產品
    
-   中期：開始帶人、做 onboarding、配置人力與流程
    
-   後期：參與公司 strategy、商業敘事、融資與整體方向
...
-   前提是能理解產品邏輯、市場在討論什麼、競品是誰
    
-   標準化 / Infra 類項目更容易讓新人直接上手
...
-   常見指標：成交金額、交易量、帶來的實際收入
    
-   抽成約 **5%–10%（依項目而異）**，歐美項目通常有底薪＋激勵
    

**5\. 跑會與資源判斷**

-   跑會是 Web3 中獲取有效客戶的高效方式
    
-   Hackathon 對 BD 價值較低
    
-   優先關注：有預算、能做 side event、已驗證需求的中大型項目
...
-   上幣 BD、KOL BD、Marketing BD 哪個適合新手？
...
-   市場上存在 **無底薪或極低底薪的 BD 職缺**
    
-   歐洲 / 美國項目相對制度完整、底薪合理，但門檻較高
    
-   高薪 BD 通常需：帶團隊＋可量化成果（如交易量）
...
-   中後期可透過既有人脈、轉介紹、遠端建聯降低跑會頻率
    

**4\. 各類 BD 角色適配度**

-   **KOL BD**：較適合新手（你是買方、有預算）
    
-   **上幣 BD**：高度依賴平台品牌與資源，不適合零資源新手
    
-   **Marketing / Community**：常作為 BD 的前置跳板
...
-   I 人也能做 BD，但跑會成本高，需找到適合自己的方式
    
-   BD 核心能力不是話術，而是共情、理解需求與持續跟進
...
## 下午線上共學時Wachi老師提出了殘酷共學目前可以讓大家去思考的問題，

-   訓練營名額限制500人，  
    主要因為微信群的人數上限以及助教的精力分配有限，  
    因此在一開始審核報名表時，除了填寫報名表的用心程度以外，會看到的重點是，這位學員是否真的真的有心學習，對於課程的安排是面向想認識/進入Web3的新手小白，學生等，審核步驟會先有一位助教，二次審核為Bruce老師。  
    但蠻多同學是一開始就沒有打卡，或是水筆記、任務，這次提到了這部分，
    
-   **我自己的想法是 :**
    

1.  因為教材都是公開的，可以使用完成**營前任務**的方式，去判斷這位學員的學習狀態，題目從這些開源教材裡面出，為期可能1周左右，再加上**報名表填寫的完善程度**，應該或多或少能夠先篩出一批真正願意花時間學習的同學。
    
2.  雖說是全免費的，但可以使用**報名費保證金**的方式，譬如報名通過後，確認有意願入營學習，需繳交100U的保證金額，第一週未被退訓可以返還25U的保證金，依此類推，四周過後結訓儀式可返還所有保證金(扣gas費用?)。另外給予三天的猶豫期，若有意外狀況需要退訓，可以向提出並全額返還。  
    被退訓或主動退出的名額，將給予Permissionless 模式的同學遞補上(順序依照任務得分排行)  
    ps.Wachi老師也有提到，未審核通過進入500人名單的同學可能會有被淘汰、沒被選上的感覺，基本上有九成就不太會再參加後續的活動，因此可以做一個獎勵機制，前面 自主退出/遭退訓 釋出的名額，提供給這些同學，並讓他們瓜分這塊沒收的保證金。
    

## 今日課堂紀錄

AI是一個很好用的工具，可以幫助我們學習並理解代碼，但核心觀念知識還是得去讀官方文檔案。  
甚麼都依靠 AI 去 Vibe Coding 會讓人的思維退化，且真正能夠應用的技術還是得要靠基本觀念去手搓開發代碼，

如果要使用 AI ，也要知道如何去給他下指令，轉化成為她看得懂，並輸出成我們能夠使用的技術去搭建架構，  
但當前我們還是得要去使用到 AI ，一定要去使用，因為學習能力還是非常重要的，在這個時代，各種新的 Agent 如雨後春筍般不斷冒出，在這個變遷極快的行業中還是得要有這種接觸新東西的學習能力。

在學習過程中，我們不一定要從 0-1 獨自開發出來，找一些頂級技術項目的架構，讀懂官方文檔，照著實操一邊學習，能夠知道這些是怎麼實現的就很足夠了，因為這些東西要學肯定是學不完的。

## 一、核心觀點：AI 不是單純的技術迭代，而是「認知層級的變革」

-   AI 對工程師的影響**不只是寫程式變快**，而是**整個工作流程與價值衡量方式改變**
    
-   「程式碼本身」變得廉價，**能否判斷、修正、負責**才是關鍵能力
    
-   新手與資深工程師某種程度「重新站在同一起跑線」，但**差距在基礎與認知深度**
...
> 設計 Prompt → AI 產碼 → 人工審核 / 修正 → 測試 → 上線 → 再用 AI 做審計

-   AI 並沒有讓工作變輕鬆，反而**對理解力、判斷力要求更高**
    
-   工程師角色從「碼農」轉向「決策者與審核者」
...
## 四、真正「不可被 AI 取代」的能力是什麼？

### 1\. 紮實的計算機基礎

-   資料結構、演算法、OS、資料庫、系統設計
...
（講者以「抓 ERC20 Holder 資料」為例，完整說明 AI 方案為何在實務上不可行）
...
## 六、強烈反對「隨便聊聊式（vibe / web coding）」用法
...
今日參與線上共學及BOX老師分享Web3 DevRel課堂

Monad黑客松可以去嘗試看看，不求得獎，但還是可以學一點經驗的  
技術崗位部分，消費級產品的需求可能相對不多，較大是面向C端的，可以往偏向B端/企業方向的項目去找  
找技術崗位，可能還是會需要知道一些工程師才知道的底層知識，比如**以太坊的共識機制為何、以太坊的狀態儲存是如何儲存的、Rollup、ZK-Rollup的機制是什麼、**等等，不一 定要會寫代碼，但基本知識還是要有，比如**合約部屬**、**合約驗證**，最好還是要有基本的手搓能力。  
**Monad是一條獨立的L1公練，並非一個節點 (**以EVM技術為核心  
大型公鏈的升級（不論是 EVM、生態鏈或 Solana、Aptos 等）長期都被專業套利團隊密切追蹤，這類團隊在重大更新後通常能最快適配並吃掉主要套利空間，因此升級本身不一定會為中小開發者帶來明顯優勢；雖然市場永遠存在套利機會，但與其在成熟賽道拚速度，不如從更長尾、尚未被完全系統化的方向切入，例如不同類型的套利變形，或關注升級後衍生出的架構調整與技術適配需求，轉而在賞金市場或技術服務中提供解決方案，而不是直接與大型套利團隊正面競爭。

## (以下為AI重點整理)  
  
一、DevRel 是什麼？核心定位

-   **DevRel（Developer Relations）不是單一工程職位**，而是一個「連接層」  
    → 介於 **產品 / 工程團隊 / 外部開發者** 之間
    
-   核心目標：  
    **讓外部開發者更快、更正確地理解、使用並採用產品**
    
-   在 Web3 中常以 **1–2 人小組**存在，實際上集合多種角色職能
    

* * *

## 二、DevRel 與研發（Engineering）的差異
...
## 三、DevRel 常見 10 種角色（實務上多合併）

1.  技術布道師（Evangelist）
    
2.  社群經理（Community Manager）
    
3.  技術寫作者（Technical Writer）
    
4.  Developer Experience Engineer（SDK / Tooling）
    
5.  解決方案架構師（Solution Architect）
    
6.  生態 / 增長負責人（Ecosystem / Growth）
    
7.  專案經理（PM）
    
8.  Developer Marketing
...
## 四、Web3 DevRel 的 4 大核心職責

1.  **傾聽與回饋**
    
    -   收集開發者痛點（文件錯誤、模板跑不起來、流程不直覺）
...
-   **職缺真的不多**
    ...
    -   消費級產品（C 端）幾乎不需要 DevRel
        
    -   基礎設施 / Developer 工具（B / D 端）才需要
...
不論是否為技術崗位，對任何事物都要有基本的認知學習能力，目前許多人也都不是計算機相關背景。  
舉例 : 對於情緒、資金流向的敏感度

可以從 clone、copy 別人的模板、公共資源庫的開源代碼，從基礎開始了解，再去嘗試開發。  
從 CoinMarketCap 中的不同板塊 (Defi 等) 順著榜單個別點開每個項目去一個個了解，看GitHub是否有開源

對於VC路線，如何去培養自己的能力  
主要還是需要增加自己被看到和prove自己眼光的能力，  
必須是比較 solid 的輸出自己的理解、而不是透過那些KOL的二手消息去統整而已

-   借鑑拼多多（黃崢）的理論，認為區塊鏈可以將「眾人的確定性」打包，類似於拼多多將採購需求聚合後與商家博弈。
    
-   區塊鏈的「**共同驗算帳本**」特性，也許可以用在類似美團、閑魚的「小法庭」仲裁機制上，作為除博弈以外的新增長點。
    
-   區塊鏈本質是**數據驗證層**。在電商等場景下，將數據發送到全球數百個節點去驗證並永久儲存，其**成本與必要性**存疑。
    

**普及瓶頸**：大部分普通用戶並不需要區塊鏈提供的「強驗證」強度，現有的中心化 APP 效率更高。

**社會實驗的侷限**：雖然技術上可以實現「鏈上社保」等智能合約，但這類應用無法對抗主權國家的權力，因此難以推廣。

-   **仲裁的終點是信任**：
    
    -   **結算難題**：預測市場（Prediction Market）有明確的客觀事實作為結算依據，但「法庭仲裁」涉及主觀判斷。
        
    -   **AI 與偏見**：即便引入 AI 擔任法官，不同文化背景（如中美）的人也難以信任對方的 AI 邏輯。
        
-   區塊鏈能解決「信任問題」（Trustless），但解決不了\*\*「人性的偏見與需求」\*\*。這也是 Web3 行業目前發展受限、產品難以大眾化的根本原因。
...
學得廣之外，需要有一個 **長板** 是蠻重要的

-   審美好 -> 嘗試著去做一些產品的設計圖、原型圖
    
-   文字/輸出能力好 -> 保持一個寫作的習慣，時不時的輸出一下 (ex: 經營X 個人ip
    
-   運營商務 -> 積極活躍在各個論壇 or 線下活動
    

蘇珠 (3AC創始人) :**如果你不管理風險，市場就會替你管理風險**

**VC機構和媒體的區別**

-   共通點 : 都要有好的表達能力，能夠產出 Solid 的文章
    
-   區別 : VC是面向老闆，寫報告讓上層看的 / 媒體是面向大眾的  
    **\-** VC它是不用考慮轉化和拉新和增長的，不是一個工具，VC只是存在在那里幫人管錢而已。VC產報告頻率低但精鍊  
    **\-** 作為媒體，要去保證規模去獲得商業包，要維持你的規模和用戶不流失，要學會樣用文章去做這方面的增長，文章的話要會寫，有角度，保持一定的更新頻率
    
    需要先发掘你想写什么，什么东西能激发你的表达欲，然后才是写作层面这种非常technical的事情。  
    可以去自己给自己创造背景，比方说你多去参加网课，然后你参加这些黑客松这实习计划，这些都可以成为背景，然后你都可以好好**写，你学到了什么、做了什么？重点是做了什么？**
    

* * *

今日線上共學，ECHO分享了一些行業內的八卦(?，入行時需要注意的事項，。過去當 KOL 時看到許多行業內的秘辛，項目方是如何聯合大 V 割散戶的，這個行業處處要小心。

小白如何參與線下活動、Side Event，多去社交、認識人，遇到有興趣的項目方可以多聊聊，大膽去要聯絡方式，有需求的時候可以直接發消息，即使之前未曾對話過，建議線下活動 I 人可以帶著 E 人朋友組隊，較內向的小白容易被騙。

要買陶瓷可以找ECHO老師 (哈哈

## 今日課堂紀錄-Web3媒體人日常

今日是較少看到的媒體崗位，其中老師有提到小白如何在初期去訓練自己的文字能力，堅持創作，不需把標準設得太高，但固定產出是很重要的。對於行業要有敏感度，撰寫的資料可以是二手，但不要寫一些空穴來風的假消息，雖然盡量還是一手消息好。當然外語能力還很重要的，許多一手消息都是英文圈，不一定要能夠懂，但敏銳度還是要有的，可以搭配AI去做整理，分析客觀看法。多找一些大媒體，比如老師的\_PANews，\_多看，多分析它們是如何下手、如何分析的，分析架構，帶著問題去閱讀，嘗試將這些手法內化到自己身上，鍛鍊網感

## 一、Web3 媒體的核心定位

**三大核心價值**

1.  **資訊分發**：快速、準確傳遞市場與產業資訊
    
2.  **市場教育**：降低新手理解門檻，解釋 DeFi、代幣、機制
    
3.  **價值發現**：找出尚未被市場充分定價的項目與敘事（alpha）
    

> Web3 媒體不只是「報新聞」，而是同時服務投資人、從業者、開發者與一般讀者。

## 二、Web3 媒體與 Web2 媒體的差異

-   **資訊透明度更高**：鏈上資料、交易數據公開
    
-   **節奏更快**：市場波動快，對「即時性」要求極高
    
-   **多元角色**：媒體同時面向投資人、交易者、KOL、項目方
    
-   **觀點重要性提升**：單純轉述新聞價值有限，觀點與整理能力更關鍵
...
> AI 是工具，不是決策者；過度依賴會削弱個人思考。

(使用AI時也須注意 AI 的幻覺情況)

## 七、對想進入 Web3 媒體的建議

1.  **先建立輸入源**：固定追蹤幾個高品質媒體與帳號
    
2.  **培養寫作與觀點**：不是只翻譯新聞
    
3.  **理解市場結構**：交易者、投資人、項目方需求不同
    
4.  **建立個人 IP**：長期輸出比短期流量重要
...
-   Web3 媒體的價值來自 **可信度 × 判斷力 × 敘事能力**
    
-   資訊透明時代，「整理、解釋、選擇」比「搶快」更重要
    
-   媒體人不只是寫作者，而是 **市場的翻譯者與導航者**
...
今日參與線上共學時少了挺多人的，估計都肝了一周熬夜寫黑客松代碼了。

線上共學時聊的內容也比較偏向在討論人生部分、未來規劃等等，人生有許多美好、可探索的事情  
中間有聊到民主的問題大家都感到有點危險不太敢講話hhh，但也因為我跟大多數同學的生活背景不同，聽到了許多不同的看法及觀點，想著如果我是在他們的環境下成長到如今，會是甚麼樣子，也聽大家講到身邊看過的人事物。

後面聊到個性，老師有提到可以多練習輸出，一位同學的興趣是攝影，恰好我也有同樣的興趣，但自己也沒想過可以經營自媒體帳號等等，感覺可以朝這方面去嘗試看看，前幾週運營同學的任務也有提到要多建立自己的媒體帳號，不是只有埋頭苦幹，嘗試讓大家知道自己正在進行的事情也是挺重要的。

## 今日就業簡歷指導與面經分享課堂總結

先說重點 : 老師好真實 哈哈 什麼 SB、祖墳的樣樣來，聽了挺歡樂的，但也看得出老師的個性落落大方

**核心主軸：Web3 求職與職涯判斷**

### 1\. 求職基本共識：即插即用

**技術崗位部份** : 現在實習的崗位少了，大多都希望可以立馬上工，需要即戰力

-   Web3 不論技術或非技術職位，都**幾乎不給培訓時間**。
    
-   產業文件、工具、技術已成熟，企業期待**上手即戰力**。
    
-   「什麼都會」的多邊形人才在 Web3 特別吃香。
    

### 2\. 履歷要求顯著提高

-   **內容要量化、具體**：活動成效、用戶數、留存率、鏈上數據。
    
-   **針對職缺客製履歷**，強調與該職位最相關的能力。
    
-   常見雷區：
    
    -   花花綠綠的模板（只建議黑白、黑體字）
        
    -   一份履歷投所有職位 (盡量去針對每個崗位獨立去撰寫針對性的履歷內容
        

### 3.鏈上經驗極為加分

-   海外 / 非中國市場公司高度重視「**鏈上實務經驗**」。
    
-   建議理解 BTC、ETH 白皮書，掌握「去中心化、抗單點失效」的本質。
    
-   Web2 專案可寫，但要能轉譯為 Web3 可理解的價值。
    

### 4.面試與招募特性

-   多數 Web3 公司 **1–2 輪面試即可決定**，流程快。
    
-   英文口語與書面能力是硬需求；日文、韓文為加分項。
...
-   謹慎「小交易所」「熱門敘事包裝（如 RWA 殼）」。
    
-   老闆品質、資金來源、商業模式比題材重要。
    
-   Web3 是高波動產業，適合風險承受度高的人。
    
-   國內和國外 區塊鏈最大差別就是 : **不能發幣** (之前課堂也提過，這基本踩到國家底線
    

### 7.從頭開始也無妨，大家都是這樣的

-   **舉例**，Metamask、phantom wallet 也都是從很菜的時期開始發展的
    
-   想進入行業還是得從一些基本概念開始了解，要懂得前幾年歷史中發生的大事
    
-   項目經驗重點在於體現**個人特質**，是否有責任心等
    
-   **技術**可去參與項目GitHub維護、**營運**可用社團帶領經驗、嘗試經營個人ip(許多老師都提過這點
...
-   國際主流工具組合：
    ...
    -   **Telegram + Twitter(X) + Google Meeting**
...
-   创新就是在所有人都不看好的地方，有一个人以一个很简单的方法解决了某一个问题，然后啪这个东西就改变了一切，比如说像 uniswap，比如在 uniswap 之前没有人知道，就是这么简单的一个订单撮合算法能够这么好用，然后改变一切，在 uniswap 之前就没有这么一个按钮式的swap，你必须要手工地去撞那个 contract。
    
-   **公共財、Public good** 華語圈較少 看文化土壤 ->偏向**理想化**  
    可看  
    1.GCC [https://x.com/GCCofCommons](https://x.com/GCCofCommons) (華語最大)  
    2.Gitcoin [https://x.com/gitcoin](https://x.com/gitcoin) (國外)
    
-   新手學習技術方面  
    可以多去看鏈上項目，多為開源 (獲取用戶信任)  
    Ex : Uniswap、索拉納公鏈  
    利用 AI 協助分析他們GitHub上的技術代碼，一行行了解，提升對於行業技術的理解程度  
    (哪行代码是为了安全，哪行代码是涉及资金)
...
今日參與休閒黑客松Demo Day 由於沒有參賽 純聽取各位大佬同學們的分享

許多組的項目都挺有趣、新穎的，很多是之前都沒有想過的主題，例如是監督教練、塔羅抽牌、透過玩遊戲讓小白更容易了解區塊鏈的技術架構等等

看同學展示Demo的過程中也學到很多東西，因為好像很多同學都是第一次參加，但展示出來的樣式也非常豐富，不只是在觀看的過程中不會感到枯燥，評委老師在提出問題時，也了解到一些可能在開發項目中會忽略、應該要注意的問題

且不只是項目本身的架構，前端的UI也都做得非常好，Demo的展示，項目本身的介面，都非常精緻用心

可以理解到為何一開始助教老師強烈建議要找組員，好的項目是需要幾個不同的小夥伴，各自貢獻自己的專長去共同建立的，代碼厲害的去做開發，有美感的做UI設計、影片Demo，敢於表達的做Demo報告，合作的結果能夠最大化發揮大家的長處
...
今日時間不足僅參與早上的LXDAO周會、【学员 Space】令人心动的Offer:Web3 职场生存指北，筆記後續補上
...
雖然這次沒有要參加，但這次自己也有使用AI做一些選題及合作，嘗試自己在沒有報名的情況下去做一點東西出來。

本堂課老師講到許多部份是在小白時期能夠做的事情，比如

-   _Optimism NumberNerd 寫投研報告會發放獎勵(近期關閉_
    
-   [_https://superteam.fun/earn/all?tab=bounties_](https://superteam.fun/earn/all?tab=bounties) _做任務會有獎金發放_
    
-   _之前的solar赏金任务_
    

給了一些想法及嘗試的方向，  
雖說感覺數據分析這方面挺容易被AI取代的，但我認為就跟寫代碼一樣吧，還是需要具備一些基本功的，至少要懂得怎麼看數據，不用自己統整，但至少要知道如何下指令讓AI協助整理、驗證

## 鏈上數據分析課堂記錄

-   Web3 數據分析 **不一定要會寫程式**
    
-   比起「怎麼查」，**更重要的是「為什麼看這個數據」**
    
-   現在很多工具已經「指標化、產品化」，像 Bloomberg Terminal
...
-   Dune / Token Terminal 上的現成看板
    

### 想要「短期正回饋 / 賞金」

-   Superteam Earn（小型 bounty）
    
-   各公鏈基金會（Optimism、Solana）
...
Web3 數據分析\*\*_不是技術導向_\*\*，而是「**業務 + 指標 +情境理解**」導向。  
_工具會一直換，但會問對問題的人永遠有價值_。
...
團隊 約3-4人 1人solo how 邪修:最小能夠完成即可 (含核心內容 -> **保證項目的最小呈現**  
**項目可運行最小的功能能展示即可**

-   _去掉鏈上過程，_**_核心看想法、創新點_**  
    沒有上鏈的狀況下，僅有前端的mock數據，只要能完整演示流程即可  
    Demo視頻甚至可以直接將上鏈的過程剪掉  
...
不必要想弄能一個非常完整的生態系統，做單點功能即可  
ex: 登錄系統 / 後台刪掉、多鏈下僅選一條鏈做即可 (自己最熟悉的測試網、以太坊)，不用dashboard  
\-> **視覺欺騙**
