...
今天听了简历和面试相关的分享，还收到了luna老师发的简历反馈，明天改简历。又是忙碌的一周
...
Dracken 老师说的对，不要一个人参赛  
wachi 老师说的对，不要用智谱glm4.7，这真的一言难尽  
Bruce 老师说的对，要用CodeX，CodeX逻辑能力比ClaudeCode强多了  
  
下周继续打基础，好好看看uniswap，投简历，搞个力所能及的项目。
...
-   今天唯一任务：把毕业论文绪论部分肝出来，明天全力休闲黑客松 第一章搞了一半了，
...
今天看了kite ai和spoonOS，真的好累

spoonOS框架怎么这么多bug要搞，kiteai的文档怎么还不完整，麻了
