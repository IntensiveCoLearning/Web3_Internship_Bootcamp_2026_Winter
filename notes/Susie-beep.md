...
最后一天了，希望保留失效任务，会持续学习的~感谢主办感谢各位助教老师
<!-- DAILY_CHECKIN_2026-02-08_END -->

# 2026-02-06
<!-- DAILY_CHECKIN_2026-02-06_START -->

想做任务来着，分享会太满了，一个都不错过！
...
研究每个赛道的好产品和有声量但失败的产品。区块链是记账方式革新，以后所有金融资产都在区块链上交易。
...
行业分享：分享嘉宾提出web3求职链上简历更重要，例如github、投票记录、DAO治理提案等等，开始思考产品经理或者数据分析的岗位，怎么能留下链上简历，目前想到的可能的方向：开发深度数据看板，对链上数据进行分析建模把代码上传github。
